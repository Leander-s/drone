...
uint8_t get_calib_status() { return read_register(0x35); }
...
void imu_read(DroneSensorState *state) {
  ...
  state->orientation.x =
      (float)((int16_t)((data[1] << 8) | data[0])) / 16384.0f;
  state->orientation.i =
      (float)((int16_t)((data[3] << 8) | data[2])) / 16384.0f;
  state->orientation.j =
      (float)((int16_t)((data[5] << 8) | data[4])) / 16384.0f;
  state->orientation.k =
      (float)((int16_t)((data[7] << 8) | data[6])) / 16384.0f;
}
